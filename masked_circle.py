...
mask = pygame.Surface((width, height), pygame.SRCALPHA)  # Alpha-enabled surface
pygame.draw.circle(mask, (255, 255, 255, 255), (width // 2, height // 2), width // 2)  # White circle with full alpha
...
for frame_num in range(total_frames):
    ...
    # Apply the mask to restrict visibility to the circle
